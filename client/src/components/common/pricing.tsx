...
const plans = [
  {
    ...
    features: [
        ...
        "Summary generation with limited tokens",
        "Quiz creation with basic features",
        "Flashcard support with basic features",
        "Document upload with limited size",
        "Group collaboration",
    ],
    description: 'Perfect for students in high school',
  ...
  },
  {
    ...
    features: [
      ...
      'Flashcard support with advanced features',
      'Document upload with larger size',
      'Priority support',
      'Team collaboration tools',
      'Powerpoint AI Agent'
    ],
    description: 'Ideal for colleges and universities',
  ...
  },
  {
    ...
    features: [
      ...
      'AI Tutoring Agent',
      'Document upload with unlimited size',
      'Unlock all features',
        'Advanced AI Agents',
