        ...
        <div className="relative mb-10 w-full overflow-hidden rounded-[40px] bg-orange-500 p-6 sm:p-10 md:p-20">
            <div className="absolute inset-0 hidden h-full w-full overflow-hidden md:block">
                <div className="absolute top-1/2 right-[-20%] aspect-square h-[800px] w-[800px] -translate-y-1/2">
                    ...
                    <div className="absolute inset-0 scale-[0.9] rounded-full bg-orange-300 opacity-30"></div>
                    <div className="absolute inset-0 scale-[0.8] rounded-full bg-orange-200 opacity-30"></div>
                    <div className="absolute inset-0 scale-[0.6] rounded-full bg-orange-100 opacity-30"></div>
                    <div className="absolute inset-0 scale-[0.4] rounded-full bg-orange-50 opacity-30"></div>
            ...
            <div className="relative z-10">
                <h1 className="mb-3 text-3xl font-bold text-white sm:text-4xl md:mb-4 md:text-5xl">
                    Create Summary from your documents.
                </h1>
                <p className="mb-6 max-w-xl text-base text-white sm:text-lg md:mb-8">
                    Use StudySync for generating summaries from PDF, PowerPoint, Youtube Videos, Our Lecture Handwritten Notes, and Webpage Link.
                </p>
